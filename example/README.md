...
- `pretty` 객체 옵션을 이용한 콘솔 포맷/레벨별 색상 커스텀
...
```txt
\u001B[36m[INF]\u001B[0m 2026:04:10 17:00:00 UserService => create() called {"name":"홍*동","email":"ho***@gmail.com"}
\u001B[36m[INF]\u001B[0m 2026:04:10 17:00:00 UserService => create() completed (1.24ms)
```
